...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in eval(expr, envir, enclos): Can't join on 'id' x 'id' because of incompatible types (integer / character)}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error: npred == 20 is not TRUE}}\end{kframe}
\end{knitrout}
...
\includegraphics[width=\maxwidth]{figure/dice_by_man-1} 
